  ...
  return (
    <div className="my-[150px] flex flex-col items-center gap-14">
      ...
      <div className="flex items-end gap-9">
        <div className="w-[304px] p-8 flex flex-col gap-7 rounded-2xl border border-[#1E1E1E] border-solid">
        ...
        <div className="flex flex-col">
          <div className="flex justify-center items-center rounded-t-2xl p-2 w-[304px] bg-linear-gradient(90deg bg-[#4B2DBB_0%] bg-[#B5446B_100%)]">
            <span className="uppercase text-xs font-bold">Recomendado</span>
          </div>
          <div className="p-[1.6px] bg-linear-gradient(90deg bg-[#4B2DBB_0%] bg-[#B5446B_100%)rounded-b-2xl]">
